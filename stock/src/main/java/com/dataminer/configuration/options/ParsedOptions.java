...
public class ParsedOptions {
	...
	/**
	 * Gets the calculated value. If the value from array args is failed to convert,
	 * throws an exception.
	 * 
	 * @param optionName
	...
	public <T> T get(String optionName) throws NonExistentOptionException, InvalidOptionValueException {
	...
	public class NonExistentOptionException extends Exception {
